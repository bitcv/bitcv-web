    ...
    <div class="signup">
      <h2 class="panel-title center-title" style="text-align: center;font-size: 23px;margin-bottom: 50px;">{{ $t('label.welcome') }} </h2>
        ...
        <form>
          <template>
            <div class='row' style="margin: 0;">
              ...
              <div class='col-xs-8' style="padding:0;">
                <input class='phone' v-model="mobile" type="text" :placeholder="$t('label.login_mobile_ph')" style="width:100%;">
              </div>
            </div>
          </template>
          <div class = smspanel>
          <input class = "sms-input" v-model="vcode" type="text" style="border-right-width: 0" :placeholder="$t('label.sms')" >
          ...
          <input v-model="passwd" type="password" :placeholder="$t('label.pwd')">
          <button class="signup-btn" @click.prevent="signup">{{ $t('label.registered') }}</button>
          <h5 style="margin-top: 25px;"><span style="color: #aaa;">{{ $t('label.account') }}?<router-link to="signin"><a style="cursor: pointer;"><span style="color: #ff8b13;"> {{ $t('label.login')}}</span></a></router-link></span></h5>
        </form>
    </div>
  </div>
</template>
