        ...
        <div class="indexbcv">
          ...
          <div class="indexbcv-item">
            ...
            <div v-if="language == 'cn'" class="intro-wrap">
              ...
              <p class="intro">币威30指数是数字货币市场上市值最高，流动性最好的30只数字货币，其市值占数字货币市场总市值的90%左右，包含被广泛认可的公链币，拥有技术创新的区块链应用代币等最主流的30只数字货币，能够反映投资者整体收益情况和投资者的市场预期。</p>
              <p class="intro">币威150指数是市值最高，流动性最好的180只货币的后150只币，这些币的币值占数字货币市场总市值的6%到8%，显示应用币等小币的整体行情。</p>
              <p class="intro">币威指数在币威官网http://bitcv.com/发布，每五分钟更新一次，每过一个月调整一次成分币以及成分币的自由流通量，以流通市值和流动性为调整标准，同时筛除稳定币成分，定位于交易性成分指数。在成分币调整时采用缓冲区技术，保证成分币的稳定性。</p>
            </div>
