<template>
  <div class="media">
    ...
    <el-table :data="perList">
      ...
      <el-table-column label="抓取项目">
        <template slot-scope="scope">{{ scope.row.newProj }}</template>
      </el-table-column>
      <el-table-column label="完成编辑">
        <template slot-scope="scope">{{ scope.row.projEdited }}</template>
      </el-table-column>
      <el-table-column label="审核通过">
        <template slot-scope="scope">{{ scope.row.projPass }}</template>
      </el-table-column>
      ...
      <el-table-column label="Facebook总数">
        <template slot-scope="scope">{{ scope.row.dynFb }}</template>
      </el-table-column>
      <el-table-column label="Twitter总数">
        <template slot-scope="scope">{{ scope.row.dynTw }}</template>
      </el-table-column>
...
export default {
  ...
  methods: {
    updateData () {
      this.$http.post('/api/getDynamic').then((res) => {
